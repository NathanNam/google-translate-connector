...
/**
 * A <code>GoogleTranslateConnectorMetadataAdapter</code> is a wrapper around {@link GoogleTranslateConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.1", date = "2015-09-14T03:17:06-07:00", comments = "Build UNNAMED.2613.77421cc")
public abstract class GoogleTranslateConnectorMetadataAdapter
    extends GoogleTranslateConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "GoogleTranslate";
